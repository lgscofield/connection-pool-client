...
public class RedisConnectionPool extends PoolBase<Jedis> implements ConnectionPool<Jedis> {
     ...
     * @param password   密码
     */
    public RedisConnectionPool(final PoolConfig poolConfig, final String host, final int port, final int timeout, final String password) {
     ...
     * @param timeout    超时
     */
    public RedisConnectionPool(final PoolConfig poolConfig, final String host, final int port, final int timeout) {
     ...
     * @param database   数据库
     */
    public RedisConnectionPool(final PoolConfig poolConfig, final String host, final int port, final int timeout, final String password, final int database) {
    ...
    public RedisConnectionPool(final PoolConfig poolConfig, final String host, final int port, final int connectionTimeout, final int soTimeout, final String password, final int database, final String clientName) {
        super(poolConfig, new RedisConnectionFactory(host, port, connectionTimeout, soTimeout, password, database, clientName));
    }
